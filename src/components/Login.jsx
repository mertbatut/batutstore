...
const LoginPage = () => {
    ...
    const mockData = [
        {
          "email": "Angeline_OHara68@example.com",
          "password": "KK9SFJFe7NBKiKB",
          "login": "1"
        },
        {
          "email": "Betsy.Shanahan95@example.org",
          "password": "fTzU0XFCzuVJcxu",
          "login": "2"
        },
        {
          "email": "Julio.Halvorson@example.com",
          "password": "Yy9I2l6JX0njXky",
          "login": "3"
        },
        {
          "email": "Deondre52@example.net",
          "password": "wVKfvOKabBe8Qu8",
          "login": "4"
        },
        {
          "email": "Edna95@example.com",
          "password": "CIrVxRtBR_jk_Sy",
          "login": "5"
        },
        {
          "email": "Werner11@example.com",
          "password": "JxSH2ML7SnqNmOh",
          "login": "6"
        },
        {
          "email": "Casimer.Bruen@example.org",
          "password": "c2wfcWe1wGhMknu",
          "login": "7"
        }
      ]
